...
- Dolphin is apparently a snowflake and will not use regular MIME types for images and videos and such but rather its own config. Gwenview and VLC are the respective programs for those things, so I guess just set them in the GUI when you need to.
